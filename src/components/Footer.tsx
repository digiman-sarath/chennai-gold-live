        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center space-x-2">
              <div className="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-primary to-accent">
                <span className="text-lg sm:text-xl font-bold text-primary-foreground">CG</span>
              </div>
              <div className="flex flex-col">
                <span className="text-base sm:text-lg font-bold text-foreground leading-none">Chennai Gold Price</span>
              </div>
            </div>
            <p className="text-xs sm:text-sm text-muted-foreground">
              Get live and accurate gold rates in Chennai and across Tamil Nadu. Updated daily with real-time market data.
            </p>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <p>
                Covering Chennai and all districts of Tamil Nadu with detailed gold rate information.
              </p>
              <div className="pt-2">
                <span className="text-xs text-muted-foreground">
                  © {currentYear} Chennai Gold Price. All rights reserved.
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-4">
              <a 
                href="https://chennaigoldprice.com" 
                className="text-xs hover:text-primary transition-colors"
                rel="noopener"
              >
                chennaigoldprice.com
              </a>
            </div>
          </div>
        </div>
